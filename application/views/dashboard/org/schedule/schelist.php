...
<section class="content-header">
	...
	<h1><i class="fa fa-edit fa-calendar"></i> Test<small>Schedule</small></h1>
		<ol class="breadcrumb">
            <?=set_breadcrumb();?>
		</ol>
</section>
...
<section class="content">
	<div class="box">
		...
		<div class="row">
			<div class="col-md-6"> 
				<a href="<?=base_url('Organizer/Schedule/addsche');?>" data-target="#DetailModal" data-toggle="modal" role="button" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add </a> 
	...
	<?=$listlogin;?>
		...
		<div class="box-footer clearfix">
			...
			<legend class="scheduler-border"><a role="button" data-toggle="collapse" href="#collapseSetting" aria-expanded="false" aria-controls="collapseSetting">Setting Schedule Confirmation</a></legend>
			<div id="collapseSetting" class="collapse">
			<form name="fsetperiod" class="form-inline" action="<?=$fsendper;?>" method="POST" >
			<div class="form-group">
				<label class="input-label" for="startTime"> Schedule Confirmation (Range Date) :</label>
				<div class="input-group">
