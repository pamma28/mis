...
<section class="content-header">
	...
	<h1><i class="fa fa-money fa-lg"></i> Payment<small>Data</small></h1>
		<ol class="breadcrumb">
            <?=set_breadcrumb();?>
		</ol>
</section>
...
<section class="content">
	<div class="box">
		...
		<div class="row">
			<div class="col-md-6"> 
				<a href="<?=base_url('Organizer/Payment/addpay');?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add </a> 
	...
	<?=$listpay;?>
		...
		<div class="box-footer clearfix">
			...
			<legend class="scheduler-border"><a role="button" data-toggle="collapse" href="#collapseSetting" aria-expanded="false" aria-controls="collapseSetting">Setting Registration Price</a></legend>
			<div id="collapseSetting" class="collapse">
			<form name="fsetperiod" class="form-inline" action="<?=$fsendper;?>" method="POST" >
			<div class="form-group">
				<label class="input-label" for="startTime">Registration Price (Rp.) :</label>
				<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-calendar"></i></span><?=$fprice;?>
				</div>
			</div>
			<?=$fbtnperiod;?>
			</form>
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					</br><a href="<?=base_url('Organizer/Payment/predefinedimport');?>" type="button" class="btn btn-warning btn-sm">Download sample format import .xls</a>
					...
					<span class="label label-info"><i class="fa fa-exclamation-triangle"></i> Import will automatically make the uploader as PIC.</span>
					</div>				
			</div>
