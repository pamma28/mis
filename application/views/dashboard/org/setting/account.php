...
<section class="content">
	...
	<div class="box-body">
			...
			<?php echo form_open_multipart(base_url('Organizer/setting/account'),array('name'=>'fphoacc','class'=>'form-horizontal','method'=>'POST'));?>
				<div class="panel panel-primary">
					<div class="panel-heading panel-heading-sm">
						<h3 class="panel-title text-center"><span class="fa fa-photo"></span> <b><?=$pho['title'];?></b></h3>
					</div>
		...
		<div class="col-md-6"> 
			<?php echo form_open(base_url('Organizer/setting/account'),array('name'=>'fpass','class'=>'form-horizontal','method'=>'POST'));?>
				<div class="panel panel-primary">
					<div class="panel-heading panel-heading-sm">
