...
<section class="content-header">
	...
	<h1><i class="fa fa-question fa-lg"></i> Question<small>Data</small></h1>
		<ol class="breadcrumb">
            <?=set_breadcrumb();?>
		</ol>
</section>
...
<section class="content">
	<div class="box">
		...
		<div class="row">
			<div class="col-md-6"> 
				<a href="<?=base_url('Organizer/Question/addquestsubject');?>" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#DetailModal"><i class="fa fa-plus"></i> Add </a> 
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					</br><a href="<?=base_url('Organizer/Question/predefinedimport');?>" type="button" class="btn btn-warning btn-sm">Download sample format import .xls</a>
					...
					<span class="label label-info"><i class="fa fa-info-circle"></i> The uploader will be set as User who Last Updated it.</span>
					</div>				
			</div>
