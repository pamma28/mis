...
<section class="content-header">
	...
	<h1><i class="fa fa-edit fa-lg"></i> Question <small>Type</small></h1>
		<ol class="breadcrumb">
            <?=set_breadcrumb();?>
		</ol>
</section>
...
<section class="content">
	<div class="box">
		...
		<div class="row">
			<div class="col-md-6"> 
				<a href="<?=base_url('Organizer/Question/addquesttype');?>" data-target="#DetailModal" data-toggle="modal" role="button" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add </a> 
			</div>
	...
	<div class="box-body table-responsive">
		<div class="btn-toolbar">
			<div class="btn-group">
					...
					<a href="#" class="btn btn-sm text-danger" data-finput="1" data-btn="btn btn-sm btn-danger" data-icon="fa fa-trash" data-title="Delete All" data-toggle="modal" data-target=".bs-selecteddata"><i class="fa fa-trash"></i> Delete All</a>
					</ul>
			</div>
		</div>
