...
<section class="content-header">
	...
	<h1><i class="fa fa-question fa-lg"></i> Subject Question<small>list</small></h1>
		<ol class="breadcrumb">
            <?=set_breadcrumb();?>
		</ol>
</section>
...
<section class="content">
	<div class="box">
		...
		<div class="row">
			<div class="col-md-6"> 
				<a href="<?=base_url('Organizer/Question/addquestsubject');?>" data-target="#DetailModal" data-toggle="modal" role="button" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Question-Subject</a> 
			</div>
			<div class="col-md-6 text-right">
					...
					<?php
						...
						echo form_close();
					?>
					<div class="text-right"><a href="<?=current_url();?>" class="label label-danger">Clear Search</a> </div>
			</div>
		</div>	
	</div>
	...
	<sub>NOTE: The Minimum Total Question number obtained by Maximum Question needed multiplied by 3</sub>
	</div>
