					...
					<div class="col-md-4 col-sm-6 col-xs-12">
					  <div class="info-box">
						...
						<div class="info-box-content bg-info">
						  ...
						  <span class="info-box-number"><span id="withrepcredit">Rp. -</span></span>
						  <p>Cost: Rp. 40/sms</p>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
					  <div class="info-box">
						...
						<div class="info-box-content bg-info">
						  ...
						  <span class="info-box-number"><span id="norepcredit">Rp. -</span></span>
						  <p>Cost: Rp. 20/sms</p>
						</div><!-- /.info-box-content -->
					  </div><!-- /.info-box -->
					</div><!-- /.col -->
