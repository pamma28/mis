...
<section class="content">
	<div class="box">
		...
		<div class="box-body table-responsive">
            <div class="col-md-2">
              <a class="btn btn-primary btn-block margin-bottom" href="<?=base_url('Organizer/SmsBroadcast/composesms')?>"><i class="fa fa-pencil"></i> Compose</a>
            ...
            <div class="col-md-10">
              <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <a href="<?=base_url('Organizer/SmsBroadcast');?>" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></a>
		...
		<div class="box-footer clearfix">
			...
			<legend class="scheduler-border"><a role="button" data-toggle="collapse" href="#collapseSetting" aria-expanded="false" aria-controls="collapseSetting">Setting SMS Footer</a></legend>
			<div id="collapseSetting" class="collapse">
				<h5 class="text-info"><span class="fa fa-info-circle"></span> Current SMS Footer</h5>
			...
			<div class="text-right"><?=$fbtnupdate;?></div>
			</form>		
			</div>
			</fieldset>
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					</br><a href="<?=base_url('Organizer/SmsBroadcast/predefinedimport');?>" type="button" class="btn btn-warning btn-sm">Download sample format import .xls</a>
