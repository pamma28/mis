...
<section class="content-header">
	...
	<h1><i class="fa fa-file-text-o fa-lg"></i> SMS<small>Template</small></h1>
		<ol class="breadcrumb">
            <?=set_breadcrumb();?>
		</ol>
</section>
...
<section class="content">
	<div class="box">
		...
		<div class="row">
			<div class="col-md-6"> 
				<a class="btn btn-sm btn-primary" role="button" data-toggle="modal" data-target="#DetailModal" href="<?=base_url('Organizer/SmsBroadcast/addtemplate');?>" ><i class="fa fa-plus"></i> Add </a> 
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					</br><a href="<?=base_url('Organizer/SmsBroadcast/tmppredefinedimport');?>" type="button" class="btn btn-warning btn-sm">Download sample format import .xls</a>
