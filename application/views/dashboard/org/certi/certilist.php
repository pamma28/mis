...
<section class="content">
	<div class="box">
		...
		<div class="row">
			<div class="col-md-6"> 
				<a href="<?=base_url('Organizer/Certificate/addcerti');?>" data-target="#DetailModal" data-toggle="modal" role="button" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add </a> 
	...
	<div class="box-body table-responsive">
		<div class="btn-toolbar">
			<div class="btn-group">
					...
					<a href="#" class="btn btn-sm text-success" data-finput="1" data-btn="btn btn-sm btn-success" data-icon="fa fa-check" data-title="Taken All" data-toggle="modal" data-target=".bs-selecteddata"><i class="fa fa-check"></i> Taken All</a>
					</ul>
			</div>
		</div>
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					</br><a href="<?=base_url('Organizer/Certificate/predefinedimport');?>" type="button" class="btn btn-warning btn-sm">Download sample format import .xls</a>
