...
<section class="content-header">
	...
	<h1><i class="fa fa-credit-card fa-lg"></i> Transfer Payment<small>Data</small></h1>
		<ol class="breadcrumb">
            <?=set_breadcrumb();?>
		</ol>
</section>
...
<section class="content">
	...
	<div class="box-body table-responsive">
		<div class="btn-toolbar">
			<div class="btn-group">
					...
					<a href="#" class="btn btn-sm text-success" data-finput="1" data-btn="btn btn-sm btn-success" data-icon="fa fa-check" data-title="Approve All" data-toggle="modal" data-target=".bs-selecteddata"><i class="fa fa-check"></i> Approve All</a>
					<a href="#" class="btn btn-sm text-danger" data-finput="0" data-btn="btn btn-sm btn-danger" data-icon="fa fa-ban" data-title="Reject All" data-toggle="modal" data-target=".bs-selecteddata"><i class="fa fa-ban"></i> Reject All</a>
					</ul>
			</div>
		</div>
	...
	<?=$listdata;?>
		...
		<div class="box-footer clearfix">
			...
			<legend class="scheduler-border"><a role="button" data-toggle="collapse" href="#collapseSetting" aria-expanded="false" aria-controls="collapseSetting">Setting Payment Phase</a></legend>
			<div id="collapseSetting" class="collapse">
			<form name="fsetperiod" class="form-inline" action="<?=$fsendper;?>" method="POST" >
			<div class="form-group">
				<label class="input-label" for="startTime">Payment Phase (Range Date) :</label>
				<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-calendar"></i></span><?=$fpay;?>
				</div>
			</div>
			<?=$fbtnperiod;?>
			</form>
