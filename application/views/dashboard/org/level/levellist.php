...
<section class="content-header">
	...
	<h1><i class="fa fa-line-chart fa-lg"></i> Level <small>list</small></h1>
		<ol class="breadcrumb">
            <?=set_breadcrumb();?>
		</ol>
</section>
...
<section class="content">
	<div class="box">
		...
		<div class="row">
			<div class="col-md-6"> 
				<a href="<?=base_url('Organizer/Level/addlevel');?>" data-target="#DetailModal" data-toggle="modal" role="button" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add </a> 
			</div>
			<div class="col-md-6 text-right">
					...
					<?php
						...
						echo form_close();
					?>
					<div class="text-right"><a class="label label-danger" href="<?=base_url('Organizer/Level');?>">Clear Search</a> </div>
			</div>
		</div>
	</div>
