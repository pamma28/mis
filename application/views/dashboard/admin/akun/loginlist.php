...
<section class="content-header">
	...
	<h1><i class="fa fa-users fa-lg"></i> Manage<small>Account</small></h1>
		<ol class="breadcrumb">
            <?=set_breadcrumb();?>
		</ol>
</section>
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					</br><a href="<?=base_url('Admin/Managelogin/predefinedimport');?>" type="button" class="btn btn-warning btn-sm">Download sample format import .xls</a>
